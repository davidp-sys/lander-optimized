...
<div class="bg-white text-gray-900 dark:bg-[#0a0e1a] dark:text-slate-100 overflow-x-hidden max-w-[100vw]">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-6 md:py-14">
      <div class="flex flex-col items-center gap-5 lg:flex-row lg:gap-12">
        ...
        <div class="flex-1 text-center lg:text-left">
          ...
          <p class="mb-4 text-lg text-gray-600 dark:text-slate-400 md:text-xl">
          ...
          <div class="mb-4 rounded-2xl bg-white dark:bg-white/5 dark:backdrop-blur-xl p-5 shadow-2xl border border-gray-300 dark:border-white/10 dark:shadow-indigo-500/10 relative z-10" id="loan-form">
            ...
            <a href={CTA_URL} class="main-cta cta-pulse block w-full rounded-xl bg-indigo-600 dark:bg-gradient-to-r dark:from-indigo-500 dark:to-violet-500 px-8 text-center text-lg font-bold text-white shadow-lg dark:shadow-[0_8px_32px_-4px_rgba(99,102,241,0.5)] hover:bg-indigo-700 transition-colors {showCta ? 'show' : ''}">
              Check If You Qualify <span class="ml-1">&rarr;</span>
            </a>

            <div class="mt-3 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-gray-500 dark:text-slate-400">
        ...
        <div class="flex-1 max-w-md w-full">
          <div class="rounded-2xl bg-white dark:bg-white/5 dark:backdrop-blur-xl p-5 shadow-2xl border border-gray-300 dark:border-white/10 dark:shadow-indigo-500/10 relative z-10">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between rounded-xl bg-green-50 dark:bg-green-500/10 dark:border dark:border-green-400/20 px-4 py-2.5">
                <span class="text-sm font-medium text-gray-700 dark:text-slate-300">Loan Amount</span>
                <span class="text-lg font-bold text-green-600 dark:text-green-400">Up to $40,000</span>
              </div>
              <div class="flex items-center justify-between rounded-xl bg-green-50 dark:bg-green-500/10 dark:border dark:border-green-400/20 px-4 py-2.5">
                <span class="text-sm font-medium text-gray-700 dark:text-slate-300">Funds Available</span>
                <span class="text-lg font-bold text-green-600 dark:text-green-400">48 hours</span>
              </div>
              <div class="flex items-center justify-between rounded-xl bg-gray-50 dark:bg-white/5 dark:border dark:border-white/10 px-4 py-2.5">
                <span class="text-sm font-medium text-gray-700 dark:text-slate-300">Credit Required</span>
                <span class="text-lg font-bold text-green-600 dark:text-green-400">Low credit OK</span>
              </div>
            </div>
            <div class="mt-3 rounded-xl bg-gray-50 border border-gray-200 dark:bg-white/5 dark:border-white/10 p-3 lg:hidden">
              <div class="flex items-start gap-3">
                ...
                <div>
                  <div class="flex items-center gap-1 mb-1">
                    <span class="text-yellow-400 dark:text-amber-400 text-sm">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
                  </div>
                  <p class="text-sm text-gray-700 dark:text-slate-300">"Got approved for $15,000 in literally 5 minutes. Couldn't believe it."</p>
                  <p class="text-xs text-gray-500 dark:text-slate-400 mt-1.5 font-medium">Sarah M. &mdash; Texas</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div class="min-w-0 rounded-2xl bg-white dark:bg-white/5 dark:backdrop-blur-xl p-5 shadow-xl border border-gray-200 dark:border-white/10">
            ...
            <div class="flex items-center gap-3 border-t border-gray-100 dark:border-white/10 pt-3">
              ...
              <div>
                <p class="font-semibold text-gray-900 dark:text-slate-100 text-sm">James R.</p>
                <p class="text-xs text-gray-500 dark:text-slate-400">Florida &mdash; Approved $20,000</p>
              </div>
            </div>
          </div>
          <div class="min-w-0 rounded-2xl bg-white dark:bg-white/5 dark:backdrop-blur-xl p-5 shadow-xl border border-gray-200 dark:border-white/10">
            ...
            <div class="flex items-center gap-3 border-t border-gray-100 dark:border-white/10 pt-3">
              ...
              <div>
                <p class="font-semibold text-gray-900 dark:text-slate-100 text-sm">Linda P.</p>
                <p class="text-xs text-gray-500 dark:text-slate-400">Ohio &mdash; Approved $12,000</p>
              </div>
            </div>
          </div>
          <div class="min-w-0 rounded-2xl bg-white dark:bg-white/5 dark:backdrop-blur-xl p-5 shadow-xl border border-gray-200 dark:border-white/10">
            ...
            <div class="flex items-center gap-3 border-t border-gray-100 dark:border-white/10 pt-3">
              ...
              <div>
                <p class="font-semibold text-gray-900 dark:text-slate-100 text-sm">Marcus W.</p>
                <p class="text-xs text-gray-500 dark:text-slate-400">Georgia &mdash; Approved $35,000</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="relative pb-12">
      <div class="mx-auto max-w-md md:max-w-7xl px-4">
        <div class="grid grid-cols-2 gap-4 md:flex md:flex-wrap md:items-center md:justify-center md:gap-12">
          <div class="flex items-center justify-center gap-1.5 text-gray-500 dark:text-slate-400">
  ...
  {#if popup}
    <div
      ...
      aria-live="polite"
    >
      <div class="flex-shrink-0 h-9 w-9 rounded-full bg-green-100 dark:bg-green-500/15 dark:ring-1 dark:ring-green-400/30 flex items-center justify-center">
  ...
  <div class="sticky-cta fixed bottom-0 left-0 w-full z-50 bg-white/95 dark:bg-slate-950/85 backdrop-blur-xl border-t border-gray-200 dark:border-white/10 py-3 px-4 shadow-2xl {showSticky ? 'visible' : ''}">
    <div class="flex flex-col items-center">
      ...
      <p class="mt-1.5 text-xs text-gray-400 dark:text-slate-500">Free to apply &bull; Low credit approvals</p>
    </div>
  </div>
</div>
