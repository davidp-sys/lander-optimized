...
<div class="bg-white text-gray-900 dark:bg-slate-950 dark:text-gray-100 overflow-x-hidden max-w-[100vw]">
  ...
  <!-- HERO SECTION -->
  <section class="relative overflow-hidden bg-gradient-to-br from-indigo-100 via-purple-100 to-blue-100 dark:from-slate-950 dark:via-indigo-950 dark:to-slate-900 min-h-screen md:min-h-0">
    ...
    <div class="relative mx-auto max-w-7xl px-4 py-6 md:py-14">
      <div class="flex flex-col items-center gap-5 lg:flex-row lg:gap-12">
        ...
        <div class="flex-1 text-center lg:text-left">
          <h1 bind:this={headlineEl} class="mb-2 font-black leading-tight tracking-tight text-gray-900 dark:text-white {data.state ? 'state-headline' : 'text-4xl md:text-5xl lg:text-6xl'}">
            {#if data.state}
              ...
              <span class="headline-line">can secure up to <span class="text-indigo-600 dark:text-indigo-400 glisten-text">$40,000</span></span>
            {:else}
              Secure Up To<br class="md:hidden"><span class="hidden md:inline"> </span><span class="text-indigo-600 dark:text-indigo-400 glisten-text">$40,000</span>
            {/if}
          </h1>

          <p class="mb-4 text-lg text-gray-600 dark:text-gray-300 md:text-xl">
            Banks can't deny you from applying.<br>Get approved in minutes.
          </p>

          <div class="geo-pill {geoRevealed ? 'revealed' : ''} mb-2 inline-flex items-center gap-2.5 rounded-lg bg-indigo-50 border border-indigo-300 dark:bg-indigo-500/10 dark:border-indigo-500/40 dark:text-indigo-300 px-4 py-1.5 text-sm font-medium text-indigo-700">
          ...
          <div class="mb-4 inline-flex items-center gap-2 rounded-lg bg-orange-50 border border-orange-300 dark:bg-orange-500/10 dark:border-orange-500/40 dark:text-orange-300 px-4 py-1.5 text-sm font-medium text-orange-700">
          ...
          <!-- MICRO-FORM -->
          <div class="mb-4 rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-2xl border border-gray-300 dark:border-slate-700 relative z-10" id="loan-form">
            <p class="mb-2 text-base font-semibold text-gray-800 dark:text-gray-100">How much do you need?</p>
            <div class="flex gap-2">
              {#each [10000, 20000, 30000, 40000] as amount}
                <button
                  class="amount-btn flex-1 rounded-lg border-2 py-3 text-center font-bold text-2xl {selectedAmount === amount ? 'selected border-indigo-600 bg-indigo-600 text-white' : 'border-indigo-200 bg-indigo-50 text-indigo-700 dark:border-indigo-500/40 dark:bg-indigo-500/10 dark:text-indigo-300'}"
            ...
            <div class="mt-3 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-gray-500 dark:text-gray-400">
        ...
        <div class="flex-1 max-w-md w-full">
          <div class="rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-2xl border border-gray-300 dark:border-slate-700 relative z-10">
            <!-- Google Maps embed centered on visitor's state -->
            <div class="mb-4">
              <div class="relative rounded-xl overflow-hidden border border-indigo-100 dark:border-slate-700 shadow-sm" style="aspect-ratio: 16 / 11;">
                {#if data.state}
                  <iframe
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between rounded-xl bg-green-50 dark:bg-green-500/10 px-4 py-2.5">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Loan Amount</span>
                <span class="text-lg font-bold text-green-600 dark:text-green-400">Up to $40,000</span>
              </div>
              <div class="flex items-center justify-between rounded-xl bg-green-50 dark:bg-green-500/10 px-4 py-2.5">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Funds Available</span>
                <span class="text-lg font-bold text-green-600 dark:text-green-400">48 hours</span>
              </div>
              <div class="flex items-center justify-between rounded-xl bg-gray-50 dark:bg-slate-700/50 px-4 py-2.5">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Credit Required</span>
                <span class="text-lg font-bold text-green-600 dark:text-green-400">Low credit OK</span>
              </div>
            </div>
            <div class="mt-3 rounded-xl bg-gray-50 dark:bg-slate-700/50 border border-gray-200 dark:border-slate-600 p-3 lg:hidden">
              <div class="flex items-start gap-3">
                <div class="flex-shrink-0 h-10 w-10 rounded-full bg-indigo-100 dark:bg-indigo-500/20 flex items-center justify-center text-sm font-bold text-indigo-600 dark:text-indigo-300">SM</div>
                <div>
                  <div class="flex items-center gap-1 mb-1">
                    <span class="text-yellow-400 text-sm">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
                  </div>
                  <p class="text-sm text-gray-700 dark:text-gray-300">"Got approved for $15,000 in literally 5 minutes. Couldn't believe it."</p>
                  <p class="text-xs text-gray-500 dark:text-gray-400 mt-1.5 font-medium">Sarah M. &mdash; Texas</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <!-- CONTENT SECTION -->
  <div class="relative overflow-hidden bg-gradient-to-br from-indigo-100 via-purple-100 to-blue-100 dark:from-slate-900 dark:via-indigo-950 dark:to-slate-900">
    ...
    <div class="relative pt-12 md:pt-16 pb-14 md:pb-20">
      <div class="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div class="min-w-0 rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-xl border border-gray-200 dark:border-slate-700">
            <div class="flex items-center gap-1 mb-2 text-yellow-400 text-sm">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <p class="text-gray-700 dark:text-gray-300 mb-4 text-sm">"I was drowning in credit card debt and my score was 580. Got matched with a lender in 5 minutes and had $20,000 deposited in 2 days."</p>
            <div class="flex items-center gap-3 border-t border-gray-100 dark:border-slate-700 pt-3">
              <div class="h-9 w-9 rounded-full bg-blue-100 flex items-center justify-center text-xs font-bold text-blue-600">JR</div>
              <div>
                <p class="font-semibold text-gray-900 dark:text-gray-100 text-sm">James R.</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">Florida &mdash; Approved $20,000</p>
              </div>
            </div>
          </div>
          <div class="min-w-0 rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-xl border border-gray-200 dark:border-slate-700">
            <div class="flex items-center gap-1 mb-2 text-yellow-400 text-sm">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <p class="text-gray-700 dark:text-gray-300 mb-4 text-sm">"I thought I'd get denied because I'm behind on my car payment. Checked my amount anyway and got approved for $12,000. Total game changer."</p>
            <div class="flex items-center gap-3 border-t border-gray-100 dark:border-slate-700 pt-3">
              <div class="h-9 w-9 rounded-full bg-purple-100 flex items-center justify-center text-xs font-bold text-purple-600">LP</div>
              <div>
                <p class="font-semibold text-gray-900 dark:text-gray-100 text-sm">Linda P.</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">Ohio &mdash; Approved $12,000</p>
              </div>
            </div>
          </div>
          <div class="min-w-0 rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-xl border border-gray-200 dark:border-slate-700">
            <div class="flex items-center gap-1 mb-2 text-yellow-400 text-sm">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <p class="text-gray-700 dark:text-gray-300 mb-4 text-sm">"My bank said no. This site connected me to a lender that said yes in minutes. No hard credit check, no stress. Wish I found this sooner."</p>
            <div class="flex items-center gap-3 border-t border-gray-100 dark:border-slate-700 pt-3">
              <div class="h-9 w-9 rounded-full bg-green-100 flex items-center justify-center text-xs font-bold text-green-600">MW</div>
              <div>
                <p class="font-semibold text-gray-900 dark:text-gray-100 text-sm">Marcus W.</p>
                <p class="text-xs text-gray-500 dark:text-gray-400">Georgia &mdash; Approved $35,000</p>
              </div>
            </div>
          </div>
        </div>
  ...
  {#if popup}
    <div
      class="approval-popup fixed z-[60] rounded-xl bg-white dark:bg-slate-800 shadow-2xl border border-gray-200 dark:border-slate-700 p-3 flex items-center gap-3 {popupVisible ? 'show' : ''} {showSticky ? 'cta-visible' : ''}"
      role="status"
      aria-live="polite"
    >
      <div class="flex-shrink-0 h-9 w-9 rounded-full bg-green-100 dark:bg-green-500/20 flex items-center justify-center">
        <svg class="h-5 w-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd"/></svg>
      </div>
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400">
          Approved for <span class="font-semibold text-green-600 dark:text-green-400">{popup.amount}</span> &middot; {popup.timeAgo}
        </p>
      </div>
    </div>
  {/if}
  ...
  <!-- STICKY CTA -->
  <div class="sticky-cta fixed bottom-0 left-0 w-full z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur border-t border-gray-200 dark:border-slate-700 py-3 px-4 shadow-2xl {showSticky ? 'visible' : ''}">
    <div class="flex flex-col items-center">
      ...
      <p class="mt-1.5 text-xs text-gray-400 dark:text-gray-500">Free to apply &bull; Low credit approvals</p>
    </div>
  </div>
</div>
